...
GO
PRINT N'Creating [dbo].[FK_Accessoires_ToType]...';


GO
ALTER TABLE [dbo].[Accessoires]
    ADD CONSTRAINT [FK_Accessoires_ToType] FOREIGN KEY ([Type]) REFERENCES [dbo].[BeestType] ([Type]);
...
GO
PRINT N'Creating [dbo].[FK_Beest_ToAccessoire]...';


GO
ALTER TABLE [dbo].[Beest]
    ADD CONSTRAINT [FK_Beest_ToAccessoire] FOREIGN KEY ([AccessoireId]) REFERENCES [dbo].[Accessoires] ([Id]);
