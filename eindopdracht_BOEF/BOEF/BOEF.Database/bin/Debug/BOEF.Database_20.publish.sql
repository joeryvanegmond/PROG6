...
-- Beest images
insert into BeestImage([Name], [ImagePath]) values ('Aap', 'C:~\Images\aap.png');
insert into BeestImage([Name], [ImagePath]) values ('Bever', 'C:~\Images\Bever.png');
insert into BeestImage([Name], [ImagePath]) values ('Doggo', 'C:~\Images\Doggo.png');
insert into BeestImage([Name], [ImagePath]) values ('Donkey', 'C:~\Images\Donkey.png');
insert into BeestImage([Name], [ImagePath]) values ('Duck', 'C:~\Images\Duck.png');
insert into BeestImage([Name], [ImagePath]) values ('IJsbeer', 'C:~\Images\IJsbeer.png');
insert into BeestImage([Name], [ImagePath]) values ('Kat', 'C:~\Images\Kat.png');
insert into BeestImage([Name], [ImagePath]) values ('Kip', 'C:~\Images\Kip.png');
insert into BeestImage([Name], [ImagePath]) values ('Koe', 'C:~\Images\Koe.png');
insert into BeestImage([Name], [ImagePath]) values ('Kuiken', 'C:~\Images\Kuiken.png');
insert into BeestImage([Name], [ImagePath]) values ('Leeuw', 'C:~\Images\Leeuw.png');
insert into BeestImage([Name], [ImagePath]) values ('Olifant', 'C:~\Images\Olifant.png');
insert into BeestImage([Name], [ImagePath]) values ('Pingwing', 'C:~\Images\Pingwing.png');
insert into BeestImage([Name], [ImagePath]) values ('Varken', 'C:~\Images\Varken.png');
insert into BeestImage([Name], [ImagePath]) values ('Zebra', 'C:~\Images\Zebra.png');
insert into BeestImage([Name], [ImagePath]) values ('Zeehond', 'C:~\Images\Zeehond.png');
insert into BeestImage([Name], [ImagePath]) values ('Pingwing', 'C:~\Images\Pingwing.png');
---- Beest images
