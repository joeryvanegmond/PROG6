...
GO
insert into BeestBeestType([Type]) values ('Boerderij');
insert into BeestBeestType([Type]) values ('Woestijn');
insert into BeestBeestType([Type]) values ('Jungle');
insert into BeestBeestType([Type]) values ('Sneeuw');
GO
