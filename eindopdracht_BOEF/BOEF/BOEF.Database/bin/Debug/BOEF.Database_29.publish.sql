...
-- Beest
insert into Beest([Name],[Type],[Prijs],[Image]) values('Aap', 'Jungle', '32', '1'); --banaan
insert into Beest([Name],[Type],[Prijs],[Image]) values('Olfiant', 'Jungle', '102', '12');
insert into Beest([Name],[Type],[Prijs],[Image]) values('Zebra', 'Jungle', '54', '15'); --zadel
insert into Beest([Name],[Type],[Prijs],[Image]) values('Leeuw', 'Jungle', '65', '11'); --zweep, krukje
insert into Beest([Name],[Type],[Prijs],[Image]) values('Hond', 'Boerderij', '12', '3'); --bal
...
insert into Beest([Name],[Type],[Prijs],[Image]) values('Pinguïn', 'Sneeuw', '45', '17'); --dansschoenen
insert into Beest([Name],[Type],[Prijs],[Image]) values('IJsbeer', 'Sneeuw', '75', '6');
insert into Beest([Name],[Type],[Prijs],[Image]) values('Zeehond', 'Sneeuw', '52', '16'); --bal
insert into Beest([Name],[Type],[Prijs],[Image]) values('Kameel', 'Woestijn', '87', '16'); 
insert into Beest([Name],[Type],[Prijs],[Image]) values('Slang', 'Woestijn', '36', '16'); 

-- Accessoire
insert into Accessoires([Name],[Price],[IdBeest]) values('Banaan', '5', '1');
insert into Accessoires([Name],[Price],[IdBeest]) values('Zadel', '22', '3');
insert into Accessoires([Name],[Price],[IdBeest]) values('Zweep', '12', '4');
insert into Accessoires([Name],[Price],[IdBeest]) values('Krukje', '25', '4');
insert into Accessoires([Name],[Price],[IdBeest]) values('Bal', '10', '5');
insert into Accessoires([Name],[Price],[IdBeest]) values('Dansschoenen', '35', '10');
insert into Accessoires([Name],[Price],[IdBeest]) values('Bal', '10', '12');
