...
GO
PRINT N'Creating [dbo].[AccessoireImage]...';


GO
CREATE TABLE [dbo].[AccessoireImage] (
    [Id]        INT        NOT NULL,
...
-- Accessoire
insert into Accessoires([Name],[Price],[IdBeest]) values('Banaan', '5', '1', '1');
insert into Accessoires([Name],[Price],[IdBeest]) values('Zadel', '22', '3', '1');
insert into Accessoires([Name],[Price],[IdBeest]) values('Zweep', '12', '4', '1');
insert into Accessoires([Name],[Price],[IdBeest]) values('Krukje', '25', '4', '1');
insert into Accessoires([Name],[Price],[IdBeest]) values('Bal', '10', '5', '1');
insert into Accessoires([Name],[Price],[IdBeest]) values('Dansschoenen', '35', '10', '1');
insert into Accessoires([Name],[Price],[IdBeest]) values('Bal', '10', '12', '1');
