...
GO
PRINT N'Creating [dbo].[AccessoireMetBoeking]...';
...
CREATE TABLE [dbo].[AccessoireMetBoeking] (
    ...
    PRIMARY KEY CLUSTERED ([AccessoireId] ASC, [BoekingId] ASC)
);
...
CREATE TABLE [dbo].[BeestMetBoeking] (
    ...
    [BoekingId] INT NOT NULL,
    PRIMARY KEY CLUSTERED ([BeestId] ASC, [BoekingId] ASC)
);
...
GO
PRINT N'Creating [dbo].[CustomerMetBoeking]...';


GO
CREATE TABLE [dbo].[CustomerMetBoeking] (
    [CustomerId] INT NOT NULL,
    [BoekingId]  INT NOT NULL,
    PRIMARY KEY CLUSTERED ([CustomerId] ASC, [BoekingId] ASC)
);


GO
PRINT N'Creating [dbo].[FK_AccessoireMetBoeking_ToBeest]...';


GO
ALTER TABLE [dbo].[AccessoireMetBoeking]
    ADD CONSTRAINT [FK_AccessoireMetBoeking_ToBeest] FOREIGN KEY ([AccessoireId]) REFERENCES [dbo].[Accessoires] ([Id]);


GO
PRINT N'Creating [dbo].[FK_AccessoireMetBoeking_ToBoeking]...';


GO
ALTER TABLE [dbo].[AccessoireMetBoeking]
    ADD CONSTRAINT [FK_AccessoireMetBoeking_ToBoeking] FOREIGN KEY ([BoekingId]) REFERENCES [dbo].[Boeking] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_CustomerMetBoeking_ToBeest]...';


GO
ALTER TABLE [dbo].[CustomerMetBoeking]
    ADD CONSTRAINT [FK_CustomerMetBoeking_ToBeest] FOREIGN KEY ([CustomerId]) REFERENCES [dbo].[Customer] ([Id]);


GO
PRINT N'Creating [dbo].[FK_CustomerMetBoeking_ToBoeking]...';


GO
ALTER TABLE [dbo].[CustomerMetBoeking]
    ADD CONSTRAINT [FK_CustomerMetBoeking_ToBoeking] FOREIGN KEY ([BoekingId]) REFERENCES [dbo].[Boeking] ([Id]);
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '0eced00f-006e-4e25-9f78-e373271c8a40')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('0eced00f-006e-4e25-9f78-e373271c8a40')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '2d43a86c-a7f0-4ab5-b4e1-079bf639417a')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('2d43a86c-a7f0-4ab5-b4e1-079bf639417a')
